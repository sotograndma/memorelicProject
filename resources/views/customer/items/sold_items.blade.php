                    ...
                    <table class="w-full border-collapse border border-gray-300">
                        <thead>
                            <tr class="bg-gray-100">
                                ...
                                <th class="border border-gray-300 px-4 py-2 text-center">TIPE BARANG</th>
                                ...
                                <th class="border border-gray-300 px-4 py-2 text-center">ALAMAT PENGIRIMAN</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($soldItems as $index => $item)
                                @foreach ($item->transactions as $transaction)
                                    <tr>
                                        ...
                                        <td class="border border-gray-300 px-4 py-2 text-center">Barang Biasa (Bukan Lelang)</td>
                            ...
                            @foreach ($soldAuctions as $index => $auction)
                                @if ($auction->transaction)
                                    <tr>
                                        <td class="border border-gray-300 px-4 py-2 text-center">L{{ $index + 1 }}</td>
                                        <td class="border border-gray-300 px-4 py-2">{{ $auction->name }}</td>
                                        <td class="border border-gray-300 px-4 py-2 text-center">Barang Lelang</td>
