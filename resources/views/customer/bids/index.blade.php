    ...
    <div class="d-flex justify-content-center mt-5">
        <div style="width: 1200px">
            <div style="color: white;border-radius:10px" class="bg_jualLelang p-5">
                <p class="fw-bold fs-1">Live Auctions – Rare Antiques Await Your Bid</p>
                <p style="font-style: italic">Discover timeless treasures, bid smart, and own history.</p>
                <div class="mt-5">
        ...
        <div style="width: 1200px">
            <ul class="nav nav-underline nav-justified" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active color_main" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Frequently Searched Items</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link color_main" id="allLive-tab" data-bs-toggle="tab" data-bs-target="#allLive-tab-pane" type="button" role="tab" aria-controls="allLive-tab-pane" aria-selected="true">All Active Auctions</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-4 gap-6">
                        @foreach ($auctions as $auction)
                            <div class="bg_jual-beli">
                                <a href="{{ route('customer.bids.show', $auction->id) }}">
                                    <img src="{{ asset('storage/' . $auction->image_path) }}" alt="{{ $auction->name }}"
